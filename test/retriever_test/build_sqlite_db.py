    ...
    with open(filename) as f:
        for line in f:
            ...
            if not doc:
                continue
            # Add the document
            documents.append((unicodedata.normalize('NFD',doc['id']), doc['text']))
    return documents
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, help='/path/to/data',default='/home/zhangzy/DocDB')
    parser.add_argument('--save_path', type=str, help='/path/to/saved/db.db',default='/home/zhangzy/ProgrammingAlpha/data')
